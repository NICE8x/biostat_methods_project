...
hate_crimes_df %>%
  ...
  labs(title = "Figure 6. Interaction Plots Between Hate Crime and All Continuous Variables by Unemployment Level", y = "Hate Crime (log)", x = "Value")
```
...
hate_crimes_df %>% 
  ...
  geom_smooth(method='lm', se=FALSE) + 
  facet_wrap(~cont_var, scales = "free_x") + 
  labs(title = "Figure 7. Interaction Plots Between Hate Crime and All Continuous Variables by Urbanization Level", y = "Hate Crime (log)", x = "Value")
```
