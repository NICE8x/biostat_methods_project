...
Through cross-validation, we determined that the aforementioned two-predictor model also had best predictive value (RMSE = 0.5949, MAE = 0.5050) than the  three-predictor model (RMSE = 0.6038, MAE = 0.5067) (Figure 11). 
