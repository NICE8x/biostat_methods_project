...
hate_crimes_df %>% 
  ...
  facet_wrap(~cont_var, scales = "free_x") + labs(title = "Figure 7. Interaction Plots Between Hate Crime and All Continuous Variables by Urbanization Level", y = "Hate Crime (log)", x = "Value", caption = "Data comes from FiveThirtyEight Hate Crimes data")
```
