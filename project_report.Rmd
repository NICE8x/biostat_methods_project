...
As seen in Table 1, four states--Hawaii, North Dakota, South Dakota, and Wyoming--did not report hate crime rate data, and thus were excluded from subsequent analyses. One state, Maine, did not report its percent of residents who were non-citizens. Washington DC was included as a state for the purposes of these analyses. 
...
summary(tab1) %>% 
  knitr::kable(caption = "Table 1: Descriptive Statistics of Entire Dataset")
```
...
As Washington DC is clearly outside of the Cook's distance line, we conclude that it is an outlier. During model development, we assessed 
