...
summary(tab1) %>% 
  ...
  kableExtra::footnote(general = "This table shows the adjusted R^2 and RMSE values for two models with DC and two models without DC for two and three predictors in each type of model.")
```
...
hate_crimes_df %>% 
  ...
  cor() %>% 
  corrplot::corrplot(method = "square", addCoef.col = "black", tl.col="black", tl.srt=60, insig = "blank", diag=FALSE, number.cex = .7, title = "Figure 5. Correlation Matrix", mar = c(0,0,1,0), caption = "Data comes from FiveThirtyEight Hate Crimes data")
```
