...
#Checking just interactions that appeared significant in the plot

plot_mod = lm(hate_crimes_log ~ gini_index + perc_pop_hs + gini_index*urbanization + perc_pop_hs*urbanization, data = hate_crimes_df)
```
