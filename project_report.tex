...
\midrule
\endhead
\texttt{Unemployment} & 1.426\tabularnewline
\texttt{Urbanization} & 1.983\tabularnewline
\texttt{Median\ Household\ Income} & 3.108\tabularnewline
\texttt{\%\ Adults\ \textgreater{}25yrs\ With\ HS\ Degree} &
3.895\tabularnewline
\texttt{\%\ of\ Population\ Not\ U.S.\ Citizens} & 3.728\tabularnewline
\texttt{Gini\ Index} & 1.845\tabularnewline
\texttt{\%\ of\ Population\ Not\ White} & 3.236\tabularnewline
\bottomrule
\end{longtable}
